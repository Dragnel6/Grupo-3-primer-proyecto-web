    ...
    public partial class empleados : System.Web.UI.Page
    {
        ...
        protected void GbEmpleados_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (datos.Read())
            {
                ...
                txtTelef.Text = datos("telefono");
                txtCorreo.Text = datos("correo");*/

                /*txtCodigo.Text = (datos.GetString(1));
                txtNombre.Text = (datos.GetString(2));
                txtApell.Text = (datos.GetString(3));
                txtTelef.Text = (datos.GetString(4));
                txtDui.Text = (datos.GetString(5));
                txtCorreo.Text = (datos.GetString(6));*/
